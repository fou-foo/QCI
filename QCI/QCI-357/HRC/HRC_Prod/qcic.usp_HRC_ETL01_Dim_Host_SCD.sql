/****** Object:  StoredProcedure [qcic].[usp_HRC_ETL01_Dim_Player_SCD]    Script Date: 16/10/2020 04:35:05 p. m. ******/
SET ANSI_NULLS ON
GO

SET QUOTED_IDENTIFIER ON
GO
	CREATE OR ALTER PROCEDURE  [qcic].[usp_HRC_ETL01_Dim_Player_SCD]
	AS
		BEGIN
		SET NOCOUNT ON;
        WITH temp as (
