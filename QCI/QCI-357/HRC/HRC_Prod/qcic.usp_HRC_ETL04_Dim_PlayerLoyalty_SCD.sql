/****** Object:  StoredProcedure [qcic].[usp_HRC_ETL04_Dim_PlayerLoyalty_SCD]    Script Date: 10/22/2020 5:29:30 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	CREATE OR ALTER   PROCEDURE  [qcic].[usp_HRC_ETL04_Dim_PlayerLoyalty_SCD]
	AS
		BEGIN
		SET NOCOUNT ON;
        WITH temp as (
