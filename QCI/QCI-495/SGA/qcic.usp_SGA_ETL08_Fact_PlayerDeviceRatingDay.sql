/****** Object:  StoredProcedure [tqcic].[usp_SGA_ETL08_Fact_PlayerDeviceRatingDay]   Script Date: 10/2/2020 5:29:43 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [tqcic].usp_SGA_ETL08_Fact_PlayerDeviceRatingDay 
@MaxDate DATE,  @days int
/*
  Inputs: @MaxDate  It is the maximum GamingDate from the table  [qcids].[Fact_PlayerDeviceRatingDay] where SystemNameInt is equal to 2 (SGA) 
